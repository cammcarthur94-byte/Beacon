...
import { saveAuditSchedule } from '@/lib/actions/schedules';
...
function SettingsContent() {
  ...
  const handleSaveGeneral = async () => {
    ...
    setStatusMessage(null);
    try {
      // Persist schedule on server
      await saveAuditSchedule({
        frequency: weeklyReport ? 'weekly' : dailyDigest ? 'daily' : 'weekly',
        is_enabled: weeklyReport || dailyDigest,
      });
  ...
  const handleWeeklyReportToggle = async (checked: boolean) => {
    ...
    try {
      ...
      if (checked) {
        setStatusMessage({
          type: 'success',
          text: 'Weekly Executive Summary schedule activated.',
        });
        setTimeout(() => setStatusMessage(null), 3500);
      }
    } catch (err) {
      console.warn('Failed to sync schedule update:', err);
    }
  };
  ...
  const handleCopyApiKey = () => {
    ...
    setStatusMessage({
      type: 'success',
      text: 'Production API key reference copied to clipboard.',
    });
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-32">
      {/* ========================================================================= */}
      {/* 1. Header (Title & Breadcrumbs matching Brand Kit Style) */}
      {/* ========================================================================= */}
      ...
      {/* ========================================================================= */}
      {/* 2. Top Navigation Tabs with Strong Active State */}
      {/* ========================================================================= */}
      <div className="flex items-center gap-1.5 p-1 rounded-xl bg-gray-100 dark:bg-zinc-800/80 border border-gray-200/80 dark:border-zinc-700/80 w-full sm:w-fit overflow-x-auto">
        <button
          type="button"
        ...
        >
          <Sliders
            className={cn(
              'w-3.5 h-3.5',
              activeTab === 'general' ? 'text-white dark:text-zinc-900' : 'text-gray-500 dark:text-zinc-400'
            )}
          />
          <span>General</span>
        </button>
        ...
        >
          <Globe
            className={cn(
              'w-3.5 h-3.5',
              activeTab === 'domains' ? 'text-white dark:text-zinc-900' : 'text-emerald-600 dark:text-emerald-400'
            )}
          />
          ...
          <span
            className={cn(
              ...
              activeTab === 'domains'
                ? 'bg-gray-800 text-gray-200 dark:bg-zinc-200 dark:text-zinc-800'
        ...
        >
          <Activity
            className={cn(
              'w-3.5 h-3.5',
              activeTab === 'queue' ? 'text-white dark:text-zinc-900' : 'text-blue-600 dark:text-blue-400'
            )}
          />
        ...
        >
          <CreditCard
            className={cn(
              'w-3.5 h-3.5',
              activeTab === 'billing' ? 'text-white dark:text-zinc-900' : 'text-purple-600 dark:text-purple-400'
            )}
          />
          ...
          <span
            className={cn(
              ...
              activeTab === 'billing'
                ? 'bg-gray-800 text-gray-200 dark:bg-zinc-200 dark:text-zinc-800'
                : 'bg-purple-50 dark:bg-purple-950 text-purple-700 dark:text-purple-300 border border-purple-200/60'
            )}
          >
            {currentTier}
          </span>
      ...
      {activeTab === 'general' && (
        <div className="space-y-10 animate-in fade-in duration-200">
            ...
            <div className="md:w-2/3 w-full border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-sm rounded-xl p-6 space-y-4">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full h-9 px-3 text-xs rounded-lg border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/60 text-gray-900 dark:text-zinc-100 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all shadow-xs"
                />
              </div>
          ...
          <section className="flex flex-col md:flex-row gap-6 md:gap-8 items-start pt-6 border-t border-gray-200/80 dark:border-zinc-800">
            ...
            <div className="md:w-2/3 w-full border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-sm rounded-xl p-6 space-y-3">
              <div className="flex items-center justify-between p-3 rounded-lg border border-gray-100 dark:border-zinc-800/80 bg-gray-50/50 dark:bg-zinc-800/30">
                <div>
              ...
              <div className="space-y-2 p-3 rounded-lg border border-gray-100 dark:border-zinc-800/80 bg-gray-50/50 dark:bg-zinc-800/30">
                ...
                {weeklyReport && (
                  <div className="pt-2 border-t border-gray-200/60 dark:border-zinc-700/60 flex items-center justify-between gap-3 animate-in fade-in">
                    <span className="text-[11px] text-emerald-600 dark:text-emerald-400 font-medium flex items-center gap-1.5">
                      <CheckCircle2 className="w-3.5 h-3.5" />
                      Print-ready data extraction schedule active
                    </span>
                    <Button
                      type="button"
                      variant="outline"
                      ...
                      className="h-7 px-2.5 text-[11px] font-semibold gap-1.5 rounded-lg border-gray-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 text-gray-800 dark:text-zinc-200 hover:bg-gray-100 dark:hover:bg-zinc-800 cursor-pointer shadow-2xs"
                    >
          ...
          {/* Split-Row Section 3: Developer API Access (Strict API Key Obfuscation) */}
          <section className="flex flex-col md:flex-row gap-6 md:gap-8 items-start pt-6 border-t border-gray-200/80 dark:border-zinc-800">
            <div className="md:w-1/3 space-y-1.5 shrink-0 md:pt-1">
              <div className="flex items-center gap-2">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative flex items-center">
                  <div className="absolute left-3 flex items-center pointer-events-none">
                    <KeyRound className="w-3.5 h-3.5 text-gray-400 dark:text-zinc-500" />
                  </div>
                  <input
                    type="password"
                    readOnly
                    value="********************************"
                    aria-label="Live Production API Secret Key"
                    className="w-full h-9 pl-9 pr-20 text-xs font-mono rounded-lg border border-gray-200 dark:border-zinc-800 bg-gray-50/70 dark:bg-zinc-900/80 text-gray-500 dark:text-zinc-400 select-none focus:outline-none cursor-default tracking-widest"
                  />
                  <div className="absolute right-1.5 flex items-center gap-1">
                    <button
                      ...
                      className="p-1.5 rounded-md text-gray-400 hover:text-gray-900 dark:hover:text-zinc-100 hover:bg-gray-200/60 dark:hover:bg-zinc-800 transition-colors cursor-pointer disabled:opacity-50"
                    >
                      <RotateCw className={cn('w-3.5 h-3.5', isRotatingKey && 'animate-spin')} />
                    </button>
                    <button
                      type="button"
                      onClick={handleCopyApiKey}
                      title={copiedKey ? 'Copied' : 'Copy API Key'}
                      className="p-1.5 rounded-md text-gray-400 hover:text-gray-900 dark:hover:text-zinc-100 hover:bg-gray-200/60 dark:hover:bg-zinc-800 transition-colors cursor-pointer"
                    >
                      {copiedKey ? (
                ...
                <p className="text-[10px] text-gray-400 dark:text-zinc-500">
                  Include this secret key in the <code className="bg-gray-100 dark:bg-zinc-800 px-1 py-0.5 rounded font-mono text-[10px]">Authorization: Bearer</code> header. Never expose production secrets in client-side bundles.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="md:w-2/3 w-full border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-sm rounded-xl p-6 space-y-5">
              ...
              <form onSubmit={handleAddDomain} className="flex flex-col sm:flex-row items-center gap-2">
                <input
                  ...
                  className="w-full sm:flex-1 h-9 px-3 text-xs rounded-lg border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/60 text-gray-900 dark:text-zinc-100 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all shadow-xs font-mono"
                />
                <Button
                  type="submit"
                  disabled={!customDomain.trim()}
                  className="w-full sm:w-auto h-9 px-4 rounded-lg bg-gray-900 hover:bg-black dark:bg-white dark:hover:bg-zinc-200 text-white dark:text-zinc-900 font-semibold text-xs flex items-center justify-center gap-1.5 shrink-0 cursor-pointer disabled:opacity-50"
                >
              ...
              <div className="space-y-2 pt-1">
                ...
                {domainsList.length === 0 ? (
                  <div className="p-6 text-center rounded-xl border border-dashed border-gray-200 dark:border-zinc-800 bg-gray-50/40 text-xs text-gray-400">
                    No custom domains connected yet. Add your subdomain above to enable white-label access.
                  </div>
                ) : (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2 self-end sm:self-auto shrink-0">
                          <a
                            ...
                            className="p-1 rounded-md text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors"
                            title="Visit domain"
                          >
              ...
              <div className="p-4 rounded-xl border border-blue-100 dark:border-blue-900/60 bg-blue-50/40 dark:bg-blue-950/20 space-y-2">
                ...
                <p className="text-[11px] text-blue-900/80 dark:text-blue-200 leading-relaxed">
                  In your DNS provider (Cloudflare, AWS Route 53, Namecheap, GoDaddy), add a <code className="px-1.5 py-0.5 bg-blue-100/80 dark:bg-blue-900/80 rounded font-mono text-[10px] font-bold">CNAME</code> record pointing your subdomain to <code className="px-1.5 py-0.5 bg-blue-100/80 dark:bg-blue-900/80 rounded font-mono text-[10px] font-bold">cname.beacon-geo.com</code>.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="flex flex-col md:flex-row gap-6 md:gap-8 items-start">
            ...
            <div className="md:w-2/3 w-full space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div className="border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-xs rounded-xl p-4 space-y-1">
                  <div className="flex items-center justify-between">
                    <span className="text-[11px] font-semibold text-gray-500">Cron Daemon</span>
                    <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
                  </div>
                  <div className="text-xl font-bold text-gray-900 dark:text-white font-mono">
                    Healthy
                  </div>
                  <p className="text-[10px] text-gray-400">All workers active</p>
                </div>

                <div className="border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-xs rounded-xl p-4 space-y-1">
                  <div className="flex items-center justify-between">
                    <span className="text-[11px] font-semibold text-gray-500">Supabase Sync</span>
                    <Database className="w-3.5 h-3.5 text-blue-500" />
                  </div>
                  <div className="text-xl font-bold text-gray-900 dark:text-white font-mono">
                    14m ago
                  </div>
                  <p className="text-[10px] text-gray-400">0 unwritten records</p>
                </div>

                <div className="border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-xs rounded-xl p-4 space-y-1">
                  <div className="flex items-center justify-between">
                    <span className="text-[11px] font-semibold text-gray-500">Avg Run Latency</span>
                    <Zap className="w-3.5 h-3.5 text-amber-500" />
                  </div>
                  <div className="text-xl font-bold text-gray-900 dark:text-white font-mono">
                    3.4s
                  </div>
                  <p className="text-[10px] text-gray-400">Optimal threshold</p>
                </div>
              </div>

              {/* Manual Worker Dispatch Banner */}
              <div className="border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-sm rounded-xl p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="space-y-0.5">
                  <div className="text-xs font-bold text-gray-900 dark:text-white flex items-center gap-2">
                    ...
                    <span className="px-2 py-0.5 rounded text-[9px] font-bold uppercase bg-blue-50 text-blue-700 dark:bg-blue-950 dark:text-blue-300 border border-blue-200/60 font-mono">
                      On-Demand
                    </span>
                  </div>
                ...
                <div className="flex items-center gap-2.5 shrink-0">
                  ...
                  <Button
                    ...
                    className="h-8.5 px-3.5 rounded-lg bg-gray-900 hover:bg-black dark:bg-white dark:hover:bg-zinc-200 text-white dark:text-zinc-900 font-semibold text-xs flex items-center gap-1.5 shadow-sm cursor-pointer disabled:opacity-50"
                  >
                    {isTriggeringQueue ? (
                      <>
          ...
          <section className="flex flex-col md:flex-row gap-6 md:gap-8 items-start pt-6 border-t border-gray-200/80 dark:border-zinc-800">
            ...
            <div className="md:w-2/3 w-full border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-sm rounded-xl p-6 space-y-3">
              {CRON_JOBS.map((job) => (
                <div
                  key={job.id}
                  className="p-3.5 rounded-xl border border-gray-100 dark:border-zinc-800/80 bg-gray-50/50 dark:bg-zinc-800/30 flex flex-col sm:flex-row sm:items-center justify-between gap-3"
                >
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                    ...
                    <div className="text-[10px] text-gray-500 font-mono">
                      {job.endpoint} • <span className="text-blue-600 dark:text-blue-400">{job.schedule}</span>
                    </div>
                  </div>

                  <div className="flex items-center gap-3 text-xs font-mono text-gray-500 dark:text-zinc-400 shrink-0">
                    <div className="text-right">
                      <div className="text-[9px] text-gray-400">Last Run:</div>
                      <div className="text-[11px] font-semibold text-gray-800 dark:text-zinc-200">
                        {job.lastRun}
                      </div>
                    </div>
                    <div className="h-5 w-px bg-gray-200 dark:bg-zinc-700" />
                    <div className="text-right">
                      <div className="text-[9px] text-gray-400">Next Run:</div>
                      <div className="text-[11px] font-semibold text-gray-800 dark:text-zinc-200">
                        {job.nextRun}
                      </div>
                    </div>
        ...
        <div className="space-y-10 animate-in fade-in duration-200">
            ...
            <div className="md:w-2/3 w-full border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-sm rounded-xl p-6 space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-gray-100 dark:border-zinc-800">
                <div className="flex items-center gap-3.5">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <span className="text-xs text-gray-500 font-medium">Current Tier:</span>
                      <span className="px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-blue-50 text-blue-700 dark:bg-blue-950 dark:text-blue-300 border border-blue-200/60 font-mono">
                        {currentTier} Plan
                      </span>
                    </div>
                ...
                {billingProfile?.stripeCustomerId && (
                  <Button
                    ...
                    variant="outline"
                    size="sm"
                    className="h-8.5 px-3.5 text-xs rounded-lg gap-1.5 shrink-0 border-gray-200 dark:border-zinc-800 cursor-pointer"
                  >
                    {portalLoading ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs pt-1">
                <div className="p-3 rounded-lg bg-gray-50/60 dark:bg-zinc-800/40 border border-gray-100 dark:border-zinc-800">
                  <div className="text-[10px] text-gray-400 font-medium">Billing Account</div>
                  <div className="font-semibold text-gray-800 dark:text-zinc-200 truncate font-mono mt-0.5">
                    {billingProfile?.email || adminEmail}
                  </div>
                </div>

                <div className="p-3 rounded-lg bg-gray-50/60 dark:bg-zinc-800/40 border border-gray-100 dark:border-zinc-800">
                  <div className="text-[10px] text-gray-400 font-medium">Payment Gateway</div>
                  <div className="font-semibold text-gray-800 dark:text-zinc-200 flex items-center gap-1.5 mt-0.5">
          ...
          <section className="flex flex-col md:flex-row gap-6 md:gap-8 items-start pt-6 border-t border-gray-200/80 dark:border-zinc-800">
            ...
            <div className="md:w-2/3 w-full grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              >
                <div>
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-gray-900 dark:text-white">Starter</span>
                    {currentTier === 'starter' && (
                  ...
                  <div className="mt-3 pt-3 border-t border-gray-100 dark:border-zinc-800 space-y-1.5">
                    {STRIPE_PLANS.starter.features.slice(0, 4).map((f, i) => (
                      <div key={i} className="flex items-center gap-1.5 text-[11px] text-gray-600 dark:text-zinc-300">
                ...
                <div className="pt-4 mt-4 border-t border-gray-100 dark:border-zinc-800">
                  <Button
                    disabled={true}
                    variant="outline"
                    className="w-full h-8 text-xs font-semibold border-gray-200 dark:border-zinc-800 text-gray-400"
                  >
              ...
              <div
                className={cn(
                  ...
                  currentTier === 'pro'
                    ...
                    : 'border-blue-300 dark:border-blue-800/80 shadow-md'
                )}
              >
                ...
                <div>
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-blue-600 dark:text-blue-400">Pro</span>
                    {currentTier === 'pro' && (
                      <span className="text-[9px] font-bold uppercase px-1.5 py-0.5 rounded bg-emerald-50 text-emerald-700 dark:bg-emerald-950 dark:text-emerald-300">
                        Active
                      </span>
                  ...
                  <div className="mt-3 pt-3 border-t border-gray-100 dark:border-zinc-800 space-y-1.5">
                    {STRIPE_PLANS.pro.features.slice(0, 4).map((f, i) => (
                      <div key={i} className="flex items-center gap-1.5 text-[11px] text-gray-700 dark:text-zinc-200 font-medium">
                ...
                <div className="pt-4 mt-4 border-t border-gray-100 dark:border-zinc-800">
                  {currentTier === 'pro' ? (
                    <Button
                      ...
                      disabled={portalLoading}
                      variant="outline"
                      className="w-full h-8 text-xs font-semibold border-blue-200 text-blue-600 hover:bg-blue-50"
                    >
                    ...
                    <Button
                      ...
                      className="w-full h-8 text-xs font-semibold bg-gray-900 hover:bg-black dark:bg-white dark:hover:bg-zinc-200 text-white dark:text-zinc-900 cursor-pointer"
                    >
              ...
              >
                <div>
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-gray-900 dark:text-white">Enterprise</span>
                    {currentTier === 'enterprise' && (
                      <span className="text-[9px] font-bold uppercase px-1.5 py-0.5 rounded bg-emerald-50 text-emerald-700 dark:bg-emerald-950 dark:text-emerald-300">
                        Active
                      </span>
                  ...
                  <div className="mt-2 flex items-baseline gap-1">
                    <span className="text-2xl font-extrabold text-gray-900 dark:text-white">$199</span>
                    <span className="text-[10px] text-gray-400">/ mo</span>
                  </div>
                  <p className="text-[11px] text-gray-500 mt-1 leading-normal">
          ...
          <section className="flex flex-col md:flex-row gap-6 md:gap-8 items-start pt-6 border-t border-gray-200/80 dark:border-zinc-800">
            ...
            <div className="md:w-2/3 w-full grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="p-4 rounded-xl border border-gray-100 dark:border-zinc-800 bg-gray-50/50 dark:bg-zinc-800/30 space-y-1">
                <div className="text-xs font-bold text-gray-900 dark:text-zinc-100 flex items-center gap-1.5">
                  <CreditCard className="w-3.5 h-3.5 text-blue-600" />
      ...
      {/* ========================================================================= */}
      {/* 5. Sticky Bottom Action Bar (Brand Kit Standard Dark Navy/Black Style) */}
      {/* ========================================================================= */}
    ...
    <React.Suspense
      fallback={
        <div className="flex items-center justify-center min-h-[400px]">
          <RotateCw className="w-6 h-6 text-gray-900 dark:text-white animate-spin" />
        </div>
      }
    >
      <SettingsContent />
